...
#[get("/posts/<id>")]
pub fn get_post(id: i64, conn: DbConn) -> Json<Value> {
...
pub fn update_post(id: i64, post: Json<NewPost>, conn: DbConn) -> Result<Json<Value>, Status> {
...
#[delete("/posts/<id>")]
pub fn delete_post(id: i64, conn: DbConn) -> Json<Value> {
